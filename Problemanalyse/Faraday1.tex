...
\begin{figure}[H]
	...
	\centering
	\includegraphics[width=0.70\textwidth]{Vildledning/Schematics/Magnetfelt_vinkelret} % Venstre billede
	\end{minipage}
	\hfill
	\begin{minipage}[b]{0.48\textwidth}
	\centering
	\includegraphics[width=0.70\textwidth]{Vildledning/Schematics/Magnetfelt_vinklet} % Højre billede
	\end{minipage}
\end{figure}
